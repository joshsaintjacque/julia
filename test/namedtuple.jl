...
#=
@test Meta.lower(Main, parse("(; f(x))")) == Expr(:error, "invalid named tuple element \"f(x)\"")
@test Meta.lower(Main, parse("(;1=0)")) == Expr(:error, "invalid named tuple field name \"1\"")
@test Meta.lower(Main, parse("(c=1,a=1,b=0,d.a)")) == Expr(:error, "field name \"a\" repeated in named tuple")
@test Meta.lower(Main, parse("(c=1,a=1,b=0,c)")) == Expr(:error, "field name \"c\" repeated in named tuple")
@test Meta.lower(Main, parse("(;d.c,c)")) == Expr(:error, "field name \"c\" repeated in named tuple")
=#
